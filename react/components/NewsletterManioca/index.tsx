...
import icoMail from '../../../assets/svg/ico_mail-newsletter-bbb.svg';
import icoUser from '../../../assets/svg/ico_user-newsletter-bbb.svg';

import "./global.css";

const NewsletterManioca = () => {
    ...
    return (
        <>
            {canUseDOM && (
                <div className="custom-manioca-newsletter">
                    <div className="container-newsletter">
                        <div className="texto-container">
                            <div className="texto-newsletter">
                                <span className="texto-newsletter__titulo">
                                    Desvende os Segredos da Amazônia com a Manioca
                                </span>
                                <span className="texto-newsletter__subtitulo">
                                Inscreva-se em nossa newsletter para receber novidades e receitas exclusivas. Explore os sabores autênticos da Amazônia de forma saudável e sustentável
                                </span>
                            </div>
                        </div>
                        ...
                        >
                            <div className="container-form__input">
                                <div className="container-form__input--group">
                                    <img src={icoUser} className="container-form__input--icon icon__user" />
                                    <input
                                ...
                                <div className="container-form__input--group">
                                    <img src={icoMail} className="container-form__input--icon icon__letter" />
                                    <input
                                        className="container-newsletter-form__input"
                                        type="email"
                                        name="email"
...
NewsletterManioca.defaultProps = defaultProps;
NewsletterManioca.schemaEditor = schemaEditor;
