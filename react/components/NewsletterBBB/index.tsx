...
import pinkRobot from '../../../assets/img/lp-bbb/pink-newsletter-robot.png';
...
const NewsletterBBB = () => {
    ...
    return (
        <>
            {canUseDOM && (
                <div className="custom-bbb-newsletter">
...
NewsletterBBB.defaultProps = defaultProps;
NewsletterBBB.schemaEditor = schemaEditor;
