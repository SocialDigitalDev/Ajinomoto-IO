...
export const ListSLA = ({
    ...
    const getOrderForm = () => {
        ...
        fetch(`/api/checkout/pub/orderform/${orderForm.id}`, fetchOptions)
            ...
            .then((orderFormResultAttachments: any) => {
                ...
                orderForm.marketingData = orderFormResultAttachments?.marketingData || orderForm?.marketingData;

                orderForm.totalizers = orderFormResultAttachments?.totalizers || orderForm?.totalizers;
                ...
                const orderFormAttached = orderForm.items?.map((orderFormItem: any) => {
                    ...
                    orderFormItem.attachments = item?.attachments || orderFormItem.attachments;
    ...
    const changeShipping = (indexDelivery: number) => {

        // callback(orderForm)

        selectDeliveryOption(orderForm?.shipping?.deliveryOptions[indexDelivery].id)

        console.log(selectDeliveryOption(orderForm?.shipping?.deliveryOptions[indexDelivery].id));
        ...
        >
            ...
            <label htmlFor={name} className="minicart-footer-shipping__label">
                <div className="minicart-footer-shipping__icon">
                    ...
                    >
                        <circle cx="25" cy="25" r="24.5" fill="#FFF" stroke="#000000" />
                        <path
