				...
				<div className="home-newsletter">
					<div className="container-newsletter">
                        <div className="texto-newsletter">
                            <span className="texto-newsletter__titulo">{defaultProps.title} <strong>{defaultProps.highlighted_title}</strong></span>
						...
						>
							...
							<div className="container-form__checkbox">
								<label htmlFor="aceite" className="txt-termos-condicoes">
									...
									<span>Concordo que a <strong>Modess</strong> pode usar meus dados de contato e interações. <a href="/institucional/politica-privacidade">Política de privacidade</a>.</span>
								</label>
